...
public class Main {
	...
	public static void main(String[] args) throws Exception{
    	...
    	DatabaseMeta databaseMeta = new DatabaseMeta(null, "MYSQL", "Native", "localhost", "kettle-master", "3306", "root", "root");
    	//资源库元对象
        ...
        repository.connect("admin", "yg161621");
        //判断是否连接成功
        ...
        runJob(repository, jobDirectory, "sendToEmail");
	}
