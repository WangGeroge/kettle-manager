...
public class RepositoryUtil {
	...
	public static void main(String[] args) throws KettleException{
		...
		kRepository.setRepositoryName("publicDatabaseSql");
		kRepository.setRepositoryUsername("admin");
		kRepository.setRepositoryPassword("yg161621");
		...
		kRepository.setDatabaseName("kettle-master");
		kRepository.setDatabaseUsername("root");
		kRepository.setDatabasePassword("root");
